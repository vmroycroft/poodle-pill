  ...
  if (items && items.length) {
    items.forEach(function (item) {
      ...
      if (!hasOwnProp.call(item, 'longname')) {
        ...
        itemsNav += '<li id="' + item.longname.replace('/', '_') + '-nav">' + linktoFn(item.longname, item.longname); // godzilla
        // itemsNav += '<li id="' + item.longname.replace(/\.|\//g, '_') + '-nav">' + linktoFn(item.longname, item.longname);
        // itemsNav += '<li id="' + item.name.replace('/', '_') + '-nav">' + linktoFn(item.longname, item.name.replace(/^module:/, ''));
        if (methods.length) {
          itemsNav += "<ul class='methods'>";

          methods.forEach(function (method) {
            itemsNav += '<li data-type="method" id="' + item.longname.replace('/', '_') + '-' + method.name + '-nav">'; // godzilla
...
function buildNav(members) {
  ...
  nav += buildMemberNav(members.namespaces, 'Namespaces', seen, linkto); // godzilla
